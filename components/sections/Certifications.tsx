...
const FALLBACK: Cert[] = [
  ...
  { id:"3", title:"OCI Multicloud Architect Professional", code:"OCI 2025", issuer:"Oracle", badge:"OCI", color:"#c74634", description:"Multicloud architecture patterns, interconnecting OCI with other cloud providers and resilient distributed systems.", credlyUrl:null, issueDate:null },
  { id:"4", title:"OCI Foundations Associate", code:"OCI 2025", issuer:"Oracle", badge:"OCI", color:"#c74634", description:"Foundational Oracle Cloud Infrastructure services, core concepts, pricing and support models.", credlyUrl:null, issueDate:null },
  { id:"5", title:"AWS with DevOps", code:"AWS", issuer:"Naresh IT", badge:"AWS", color:"#ff9900", description:"AWS services with DevOps practices — CI/CD, infrastructure as code, monitoring and automation pipelines.", credlyUrl:null, issueDate:null },
    ...
    >
      <div style={{ maxWidth: "1140px", margin: "0 auto", padding: "0 40px" }}>
        <div style={{ marginBottom: "56px" }}>
          <p style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--blue)", marginBottom: "12px" }}>
            Certifications
          </p>
          ...
          {certs.map((cert, i) => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 28px var(--card-shadow)";
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
                (e.currentTarget as HTMLElement).style.boxShadow = "0 2px 10px var(--card-shadow)";
              }}
            >
              ...
              <div style={{ padding: "24px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "14px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    <span style={{ fontSize: "11px", fontWeight: 700, padding: "4px 10px", borderRadius: "8px", background: `${cert.color}10`, color: cert.color }}>
                      {cert.code}
                    </span>
                  </div>
                </div>
                <h3 style={{ fontSize: "14px", fontWeight: 700, color: "var(--heading)", marginBottom: "6px", lineHeight: 1.4 }}>{cert.title}</h3>
                <p style={{ fontSize: "12px", color: "var(--muted)", marginBottom: "10px" }}>{cert.issuer}</p>
                ...
                {cert.credlyUrl && (
                  <a href={cert.credlyUrl} target="_blank" rel="noopener noreferrer"
                    style={{ display: "inline-flex", alignItems: "center", gap: "5px", marginTop: "12px", fontSize: "12px", fontWeight: 600, color: cert.color, textDecoration: "none" }}>
