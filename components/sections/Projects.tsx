    ...
    >
      <motion.div
        ...
        style={{
          ...
          overflowY: "auto", borderRadius: "20px", background: "#fff",
      ...
      >
        <div style={{ padding: "36px" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "20px" }}>
            <div>
              <h3 style={{ fontSize: "20px", fontWeight: 800, color: "#0f172a", marginBottom: "8px" }}>{p.title}</h3>
              {p.featured && (
                <span style={{
                  display: "inline-flex", alignItems: "center", gap: "5px",
                  padding: "4px 12px", borderRadius: "9999px", fontSize: "11px", fontWeight: 700,
                  background: "#eff4ff", color: "#1e6bff", border: "1px solid #bfdbfe",
                }}>
          ...
          <p style={{ fontSize: "15px", lineHeight: 1.75, color: "#475569", marginBottom: "16px" }}>{p.description}</p>
          {p.longDescription && (
            <p style={{ fontSize: "14px", lineHeight: 1.75, color: "#64748b", marginBottom: "24px" }}>{p.longDescription}</p>
          )}
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "22px 24px", display: "flex", flexDirection: "column", flex: 1 }}>
        <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#0f172a", marginBottom: "10px", lineHeight: 1.4 }}>
          {p.title}
        </h3>
        <p style={{ fontSize: "13px", lineHeight: 1.7, color: "#64748b", marginBottom: "16px", flex: 1 }}>
          {p.description}
        </p>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "16px" }}>
          {p.technologies.slice(0, 4).map(t => (
            <span key={t} style={{
              ...
              background: "#eff4ff", color: "#1e6bff",
            }}>{t}</span>
          ))}
          {p.technologies.length > 4 && (
            <span style={{ padding: "4px 10px", borderRadius: "9999px", fontSize: "11px", color: "#94a3b8", background: "#f8fafc" }}>
              +{p.technologies.length - 4}
            </span>
          )}
        </div>
      ...
      <div style={{ maxWidth: "1140px", margin: "0 auto", padding: "0 40px" }}>
        ...
        {projects.length === 0 ? (
          <div style={{
            ...
            <p style={{ color: "#94a3b8", fontSize: "15px" }}>Projects will appear here once added via the admin panel.</p>
          </div>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
            {featured.length > 0 && (
              <div>
                <p style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#94a3b8", marginBottom: "20px" }}>
                  Featured
                </p>
